...
class TestCboeParsers(unittest.TestCase):
    def test_parse_osi_call_and_put(self):
        ...
        self.assertEqual(_parse_osi("AAPL260702C00307500"), (dt.date(2026, 7, 2), 307.5, "call"))
        self.assertEqual(_parse_osi("AAPL260710P00110000"), (dt.date(2026, 7, 10), 110.0, "put"))

    def test_parse_osi_weekly_index_root(self):
        from src.ingest.adapters.cboe import _parse_osi
        self.assertEqual(_parse_osi("SPXW260702P05000000"), (dt.date(2026, 7, 2), 5000.0, "put"))
...
class TestCboeNormalize(unittest.TestCase):
    ...
    def test_quote_ts_from_payload_timestamp(self):
